...
new Float:FCVAR_ZOMBIE_KNIGHT_CHANCE					=		7.0; //11.1
...
new CVAR_ZOMBIE_KNIGHT_HEALTH_MIN						=		5700; //2800
new CVAR_ZOMBIE_KNIGHT_HEALTH_MAX						=		6200; //3400
new CVAR_ZOMBIE_KNIGHT_BOT_HEALTH_MIN					=		5700; //1500
new CVAR_ZOMBIE_KNIGHT_BOT_HEALTH_MAX					=		6200; //3000
...
stock UpdateBotsConfig(iPlayers = 0, bool:bNotice = true, bool:bOnlyNoticeWhenUpdated = false)
{
	...
	switch(iPlayers)
	{
		case 11, 12: iBotCount = 28;
		case 9, 10: iBotCount = 25;	
		case 7, 8: iBotCount = 20;
		case 5, 6: iBotCount = 16;
		case 4: iBotCount = 13;
		case 3: iBotCount = 11;
		case 2: iBotCount = 8;
		case 0, 1: iBotCount = 3;
		default: iBotCount = 30;
	}
//	iBotCount = 2;
	...
	if (bNotice && bUpdate)
	{
		if (iBotCount >= 25) PrintToChatAll("\x08%s僵尸： \x04地狱", COLOR_INSURGENTS);
		else if (iBotCount >= 16) PrintToChatAll("\x08%s僵尸：  \x05困难", COLOR_INSURGENTS);
		else if (iBotCount >= 8) PrintToChatAll("\x08%s僵尸：  \x05正常", COLOR_INSURGENTS);

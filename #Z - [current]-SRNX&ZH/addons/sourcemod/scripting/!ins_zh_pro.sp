...
new CVAR_PLAYER_HEALTHKIT_MEDIC_MIN_HEALTH				=			61; //80
new CVAR_PLAYER_HEALTHKIT_MEDIC_MAX_HEALTH				=			67; //90
...
new Float:FCVAR_PLAYER_REINFORCEMENT_DEPLOY_TIME				=			70.0; //90

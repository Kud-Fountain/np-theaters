...
new CVAR_PLAYER_GLOW_HEALTH								=			65;
new CVAR_PLAYER_HEALTHKIT_HEAL_MIN						=			25;
new CVAR_PLAYER_HEALTHKIT_HEAL_MAX						=			50; //50
/*new CVAR_PLAYER_HEALTHKIT_MEDIC_HEAL_MIN				=			50;
new CVAR_PLAYER_HEALTHKIT_MEDIC_HEAL_MAX				=			70;		*/
new CVAR_PLAYER_HEALTHKIT_MIN_HEALTH					=			65; //65
new CVAR_PLAYER_HEALTHKIT_MAX_HEALTH					=			75; //75
new CVAR_PLAYER_HEALTHKIT_MEDIC_MIN_HEALTH				=			80; //80
new CVAR_PLAYER_HEALTHKIT_MEDIC_MAX_HEALTH				=			90; //90
...
new Float:FCVAR_PLAYER_HEALTHKIT_BANDAGE_BASE_TIME		=			0.8;	// seconds per 10 hp //0.8
new Float:FCVAR_PLAYER_HEALTHKIT_BANDAGE_MIN_TIME		=			3.5;	//3.5
...
new Float:FCVAR_PLAYER_REINFORCEMENT_DEPLOY_TIME				=			80.0; //90
...
/**
		ZOMBIES
						**/
new CVAR_ZOMBIE_COMMON_HEALTH_MIN						=		300000;
new CVAR_ZOMBIE_COMMON_HEALTH_MAX						=		350000;
new CVAR_ZOMBIE_COMMON_BOT_HEALTH_MIN					=		350000; //300
new CVAR_ZOMBIE_COMMON_BOT_HEALTH_MAX					=		400000; //500
new Float:FCVAR_ZOMBIE_COMMON_SIZE_MIN					=		2.40;
new Float:FCVAR_ZOMBIE_COMMON_SIZE_MAX					=		2.50;
new CVAR_ZOMBIE_COMMON_COLOR_RED						=		255;
new CVAR_ZOMBIE_COMMON_COLOR_GREEN						=		255;
new CVAR_ZOMBIE_COMMON_COLOR_BLUE						=		255;
new Float:FCVAR_ZOMBIE_COMMON_SPEED_MIN					=		2.0; //1.14
new Float:FCVAR_ZOMBIE_COMMON_SPEED_MAX					=		2.1; //1.16
new Float:FCVAR_ZOMBIE_COMMON_BOT_SPEED_MIN				=		2.0; //1.15
new Float:FCVAR_ZOMBIE_COMMON_BOT_SPEED_MAX				=		2.1; //1.25
...
*/
new Float:FCVAR_ZOMBIE_STALKER_CHANCE					=		10.0; //24.4
...
new CVAR_ZOMBIE_STALKER_HEALTH_MIN						=		250000; //300
new CVAR_ZOMBIE_STALKER_HEALTH_MAX						=		300000; //400
new CVAR_ZOMBIE_STALKER_BOT_HEALTH_MIN					=		250000; //200
new CVAR_ZOMBIE_STALKER_BOT_HEALTH_MAX					=		300000; //300
// new Float:FCVAR_ZOMBIE_STALKER_PENALTY_TIME				=		40.0;
// new Float:FCVAR_ZOMBIE_STALKER_BOT_PENALTY_TIME			=		20.0;
new Float:FCVAR_ZOMBIE_STALKER_SIZE_MIN					=		2.4;
new Float:FCVAR_ZOMBIE_STALKER_SIZE_MAX					=		2.5;
new CVAR_ZOMBIE_STALKER_COLOR_RED						=		255;
new CVAR_ZOMBIE_STALKER_COLOR_GREEN						=		255;
new CVAR_ZOMBIE_STALKER_COLOR_BLUE						=		255;
new Float:FCVAR_ZOMBIE_STALKER_SPEED_MIN				=		2.0; //1.20
new Float:FCVAR_ZOMBIE_STALKER_SPEED_MAX				=		2.1; //1.22
new Float:FCVAR_ZOMBIE_STALKER_BOT_SPEED_MIN			=		2.0; //1.10
new Float:FCVAR_ZOMBIE_STALKER_BOT_SPEED_MAX			=		2.1; //1.16
...
new Float:FCVAR_ZOMBIE_KNIGHT_CHANCE					=		15.0; //11.1
...
new CVAR_ZOMBIE_KNIGHT_HEALTH_MIN						=		300000; //2800
new CVAR_ZOMBIE_KNIGHT_HEALTH_MAX						=		350000; //3400
new CVAR_ZOMBIE_KNIGHT_BOT_HEALTH_MIN					=		300000; //1500
new CVAR_ZOMBIE_KNIGHT_BOT_HEALTH_MAX					=		350000; //3000
// new Float:FCVAR_ZOMBIE_KNIGHT_PENALTY_TIME				=		50.0;
// new Float:FCVAR_ZOMBIE_KNIGHT_BOT_PENALTY_TIME			=		30.0;
new Float:FCVAR_ZOMBIE_KNIGHT_SIZE_MIN					=		2.40; //1.36
new Float:FCVAR_ZOMBIE_KNIGHT_SIZE_MAX					=		2.50; //1.44
new CVAR_ZOMBIE_KNIGHT_COLOR_RED						=		255;
new CVAR_ZOMBIE_KNIGHT_COLOR_GREEN						=		166;
new CVAR_ZOMBIE_KNIGHT_COLOR_BLUE						=		166;
new Float:FCVAR_ZOMBIE_KNIGHT_SPEED_MIN					=		2.10; //1.1
new Float:FCVAR_ZOMBIE_KNIGHT_SPEED_MAX					=		2.2; //1.12
new Float:FCVAR_ZOMBIE_KNIGHT_BOT_SPEED_MIN				=		2.10; //1.10
new Float:FCVAR_ZOMBIE_KNIGHT_BOT_SPEED_MAX				=		2.20; //1.15
...
new CVAR_ZOMBIE_BURNER_HEALTH_MIN						=		260000; //300
new CVAR_ZOMBIE_BURNER_HEALTH_MAX						=		330000; //500
new CVAR_ZOMBIE_BURNER_BOT_HEALTH_MIN					=		260000; //300
new CVAR_ZOMBIE_BURNER_BOT_HEALTH_MAX					=		300000; //450
// new Float:FCVAR_ZOMBIE_BURNER_PENALTY_TIME				=		40.0;
// new Float:FCVAR_ZOMBIE_BURNER_BOT_PENALTY_TIME			=		30.0;
new Float:FCVAR_ZOMBIE_BURNER_SIZE_MIN					=		2.4;
new Float:FCVAR_ZOMBIE_BURNER_SIZE_MAX					=		2.5;
new CVAR_ZOMBIE_BURNER_COLOR_RED						=		99;
new CVAR_ZOMBIE_BURNER_COLOR_GREEN						=		99;
new CVAR_ZOMBIE_BURNER_COLOR_BLUE						=		99;
new Float:FCVAR_ZOMBIE_BURNER_SPEED_MIN					=		2.0; //1.16
new Float:FCVAR_ZOMBIE_BURNER_SPEED_MAX					=		2.1; //1.20
new Float:FCVAR_ZOMBIE_BURNER_BOT_SPEED_MIN				=		2.0; //1.20
new Float:FCVAR_ZOMBIE_BURNER_BOT_SPEED_MAX				=		2.1; //1.25
...
new CVAR_ZOMBIE_SMOKER_HEALTH_MIN						=		300000; //300
new CVAR_ZOMBIE_SMOKER_HEALTH_MAX						=		320000; //350
new CVAR_ZOMBIE_SMOKER_BOT_HEALTH_MIN					=		300000; //250
new CVAR_ZOMBIE_SMOKER_BOT_HEALTH_MAX					=		320000; //350
// new Float:FCVAR_ZOMBIE_SMOKER_PENALTY_TIME				=		60.0;
// new Float:FCVAR_ZOMBIE_SMOKER_BOT_PENALTY_TIME			=		50.0;
new Float:FCVAR_ZOMBIE_SMOKER_SIZE_MIN					=		2.4;
new Float:FCVAR_ZOMBIE_SMOKER_SIZE_MAX					=		2.5;
new CVAR_ZOMBIE_SMOKER_COLOR_RED						=		188;
new CVAR_ZOMBIE_SMOKER_COLOR_GREEN						=		188;
new CVAR_ZOMBIE_SMOKER_COLOR_BLUE						=		188;
new Float:FCVAR_ZOMBIE_SMOKER_SPEED_MIN					=		2.10; //1.10
new Float:FCVAR_ZOMBIE_SMOKER_SPEED_MAX					=		2.25; //1.15
new Float:FCVAR_ZOMBIE_SMOKER_BOT_SPEED_MIN				=		2.10; //1.20
new Float:FCVAR_ZOMBIE_SMOKER_BOT_SPEED_MAX				=		2.25; //1.25
...
new Float:FCVAR_ZOMBIE_IED_CHANCE								=		0.0; //12.22
...
new Float:FCVAR_ZOMBIE_IED_SPEED_MIN							=		1.30; //1.20
new Float:FCVAR_ZOMBIE_IED_SPEED_MAX							=		1.40; //1.30
new Float:FCVAR_ZOMBIE_IED_BOT_SPEED_MIN						=		1.30; //1.20
new Float:FCVAR_ZOMBIE_IED_BOT_SPEED_MAX						=		1.40; //1.30
...
new CVAR_ZOMBIE_LEAPER_HEALTH_MIN						=		270000; //300
new CVAR_ZOMBIE_LEAPER_HEALTH_MAX						=		330000; //400
new CVAR_ZOMBIE_LEAPER_BOT_HEALTH_MIN					=		270000; //250
new CVAR_ZOMBIE_LEAPER_BOT_HEALTH_MAX					=		330000; //350
// new Float:FCVAR_ZOMBIE_LEAPER_PENALTY_TIME				=		40.0;
// new Float:FCVAR_ZOMBIE_LEAPER_BOT_PENALTY_TIME			=		20.0;
new Float:FCVAR_ZOMBIE_LEAPER_SIZE_MIN					=		2.4;
new Float:FCVAR_ZOMBIE_LEAPER_SIZE_MAX					=		2.5;
new CVAR_ZOMBIE_LEAPER_COLOR_RED						=		120;
new CVAR_ZOMBIE_LEAPER_COLOR_GREEN						=		102;
new CVAR_ZOMBIE_LEAPER_COLOR_BLUE						=		255;
new Float:FCVAR_ZOMBIE_LEAPER_SPEED_MIN				=		2.10; //1.20
new Float:FCVAR_ZOMBIE_LEAPER_SPEED_MAX				=		2.20; //1.25
new Float:FCVAR_ZOMBIE_LEAPER_BOT_SPEED_MIN				=		2.10; //1.20
new Float:FCVAR_ZOMBIE_LEAPER_BOT_SPEED_MAX				=		2.20; //1.25
...
new Float:FCVAR_ZOMBIE_BURN_BONUS_SPEED_MIN				=			0.20; //0.14
new Float:FCVAR_ZOMBIE_BURN_BONUS_SPEED_MAX				=			0.25; //0.20
...
stock UpdateBotsConfig(iPlayers = 0, bool:bNotice = true, bool:bOnlyNoticeWhenUpdated = false)
{
	...
	switch(iPlayers)
	{
		case 11, 12: iBotCount = 2;
		case 9, 10: iBotCount = 2;	
		case 7, 8: iBotCount = 2;
		case 5, 6: iBotCount = 2;
		case 4: iBotCount = 2;
		case 3: iBotCount = 2;
		case 2: iBotCount = 2;
		case 0, 1: iBotCount = 2;
		default: iBotCount = 2;
	}
//	iBotCount = 2;
	...
	if (bNotice && bUpdate)
	{
		if (iBotCount >= 2) PrintToChatAll("\x08%s僵尸： \x04超出读数", COLOR_INSURGENTS);
		else if (iBotCount >= 4) PrintToChatAll("\x08%s僵尸：  \x05困难", COLOR_INSURGENTS);
		else if (iBotCount >= 4) PrintToChatAll("\x08%s僵尸：  \x05正常", COLOR_INSURGENTS);

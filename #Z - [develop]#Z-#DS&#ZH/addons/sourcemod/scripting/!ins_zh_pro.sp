...
new CVAR_PLAYER_HEALTHKIT_MIN_HEALTH					=			40; //65
new CVAR_PLAYER_HEALTHKIT_MAX_HEALTH					=			45; //75
new CVAR_PLAYER_HEALTHKIT_MEDIC_MIN_HEALTH				=			55; //80
new CVAR_PLAYER_HEALTHKIT_MEDIC_MAX_HEALTH				=			65; //90
...
new Float:FCVAR_ZOMBIE_COMMON_SPEED_MIN					=		1.24; //1.14
new Float:FCVAR_ZOMBIE_COMMON_SPEED_MAX					=		1.26; //1.16
new Float:FCVAR_ZOMBIE_COMMON_BOT_SPEED_MIN				=		1.25; //1.15
new Float:FCVAR_ZOMBIE_COMMON_BOT_SPEED_MAX				=		1.35; //1.25
...
*/
new Float:FCVAR_ZOMBIE_STALKER_CHANCE					=		22.6; //24.4
...
new Float:FCVAR_ZOMBIE_STALKER_SPEED_MAX				=		1.32; //1.22
new Float:FCVAR_ZOMBIE_STALKER_BOT_SPEED_MIN			=		1.20; //1.10
new Float:FCVAR_ZOMBIE_STALKER_BOT_SPEED_MAX			=		1.26; //1.16
...
new Float:FCVAR_ZOMBIE_KNIGHT_CHANCE					=		0.8; //11.1
...
new CVAR_ZOMBIE_KNIGHT_HEALTH_MIN						=		57000; //2800
new CVAR_ZOMBIE_KNIGHT_HEALTH_MAX						=		62000; //3400
new CVAR_ZOMBIE_KNIGHT_BOT_HEALTH_MIN					=		57000; //1500
new CVAR_ZOMBIE_KNIGHT_BOT_HEALTH_MAX					=		62000; //3000
// new Float:FCVAR_ZOMBIE_KNIGHT_PENALTY_TIME				=		50.0;
// new Float:FCVAR_ZOMBIE_KNIGHT_BOT_PENALTY_TIME			=		30.0;
new Float:FCVAR_ZOMBIE_KNIGHT_SIZE_MIN					=		1.60; //1.36
new Float:FCVAR_ZOMBIE_KNIGHT_SIZE_MAX					=		1.70; //1.44
new CVAR_ZOMBIE_KNIGHT_COLOR_RED						=		255;
new CVAR_ZOMBIE_KNIGHT_COLOR_GREEN						=		166;
new CVAR_ZOMBIE_KNIGHT_COLOR_BLUE						=		166;
new Float:FCVAR_ZOMBIE_KNIGHT_SPEED_MIN					=		1.20; //1.1
new Float:FCVAR_ZOMBIE_KNIGHT_SPEED_MAX					=		1.22; //1.12
new Float:FCVAR_ZOMBIE_KNIGHT_BOT_SPEED_MIN				=		1.20; //1.10
new Float:FCVAR_ZOMBIE_KNIGHT_BOT_SPEED_MAX				=		1.25; //1.15
...
new Float:FCVAR_ZOMBIE_BURNER_SPEED_MIN					=		1.26; //1.16
new Float:FCVAR_ZOMBIE_BURNER_SPEED_MAX					=		1.30; //1.20
new Float:FCVAR_ZOMBIE_BURNER_BOT_SPEED_MIN				=		1.30; //1.20
new Float:FCVAR_ZOMBIE_BURNER_BOT_SPEED_MAX				=		1.35; //1.25
...
new Float:FCVAR_ZOMBIE_SMOKER_SPEED_MIN					=		1.20; //1.10
new Float:FCVAR_ZOMBIE_SMOKER_SPEED_MAX					=		1.25; //1.15
new Float:FCVAR_ZOMBIE_SMOKER_BOT_SPEED_MIN				=		1.30; //1.20
new Float:FCVAR_ZOMBIE_SMOKER_BOT_SPEED_MAX				=		1.35; //1.25
...
new Float:FCVAR_ZOMBIE_LEAPER_SPEED_MAX				=		1.35; //1.25

...
#define PLUGIN_VERSION "1.1/1.6.1"
...
/**			WEAPON INDEX VALUES			**/
#define		WEAPON_FLAREGUN		18
#define		WEAPON_HEALTHKIT	1
#define		WEAPON_LAW			15
#define		WEAPON_AT4			3
#define		WEAPON_KABAR		2
...
new Float:FCVAR_BOT_WEAPONCACHE_INTEL_MODE_CHANCE						=			15.10; //10.10
...
new CVAR_PLAYER_GLOW_HEALTH								=			50;
new CVAR_PLAYER_HEALTHKIT_HEAL_MIN						=			25;
new CVAR_PLAYER_HEALTHKIT_HEAL_MAX						=			30; //50
/*new CVAR_PLAYER_HEALTHKIT_MEDIC_HEAL_MIN				=			50;
new CVAR_PLAYER_HEALTHKIT_MEDIC_HEAL_MAX				=			70;		*/
new CVAR_PLAYER_HEALTHKIT_MIN_HEALTH					=			35; //65
new CVAR_PLAYER_HEALTHKIT_MAX_HEALTH					=			40; //75
new CVAR_PLAYER_HEALTHKIT_MEDIC_MIN_HEALTH				=			50; //80
new CVAR_PLAYER_HEALTHKIT_MEDIC_MAX_HEALTH				=			55; //90
...
new Float:FCVAR_PLAYER_HEALTHKIT_BANDAGE_MIN_TIME		=			4.0;	//3.5
new Float:FCVAR_PLAYER_HEALTHKIT_MEDIC_BANDAGE_BASE_TIME=			0.7;	// seconds per 10 hp //0.5
new Float:FCVAR_PLAYER_HEALTHKIT_MEDIC_BANDAGE_MIN_TIME	=			3.0;	//3.0
...
new CVAR_PLAYER_REINFORCEMENT_RATIO								=			10;
new CVAR_PLAYER_REINFORCEMENT_MIN								=			1;
new CVAR_PLAYER_REINFORCEMENT_MAX								=			1; //6
...
new CVAR_PLAYER_REINFORCEMENT_MAX_PER_POINT						=			0;
new Float:FCVAR_PLAYER_BLEEDING_BULLET_CHANCE					=			33.33;
//new Float:FCVAR_PLAYER_BLEEDING_EXPLOSIVE_CHANCE				=			44.44;
new Float:FCVAR_PLAYER_BLEEDING_INTERVAL_MIN					=			5.0; //10
new Float:FCVAR_PLAYER_BLEEDING_INTERVAL_MAX					=			8.0; //20
new CVAR_PLAYER_BLEEDING_DAMAGE_MIN								=			9; //2
new CVAR_PLAYER_BLEEDING_DAMAGE_MAX								=			15; //6
new Float:FCVAR_PLAYER_INFECTION_CHANCE							=		66.66; //33.3
new Float:FCVAR_PLAYER_INFECTION_TIMEINTERVAL_MIN				=		5.0; //10
new Float:FCVAR_PLAYER_INFECTION_TIMEINTERVAL_MAX				=		8.0; //20
...
new Float:FCVAR_FINAL_COUNTERATTACK_TIME						=			300.0;
...
/**
		ZOMBIES
						**/
new CVAR_ZOMBIE_COMMON_HEALTH_MIN						=		500;
new CVAR_ZOMBIE_COMMON_HEALTH_MAX						=		600;
...
new Float:FCVAR_ZOMBIE_COMMON_SPEED_MIN					=		1.34; //1.14
new Float:FCVAR_ZOMBIE_COMMON_SPEED_MAX					=		1.36; //1.16
new Float:FCVAR_ZOMBIE_COMMON_BOT_SPEED_MIN				=		1.35; //1.15
new Float:FCVAR_ZOMBIE_COMMON_BOT_SPEED_MAX				=		1.45; //1.25
...
new CVAR_ZOMBIE_BLINKER_HEALTH_MIN						=		1300; //300
new CVAR_ZOMBIE_BLINKER_HEALTH_MAX						=		1800; //360
new CVAR_ZOMBIE_BLINKER_BOT_HEALTH_MIN					=		1300; //200
new CVAR_ZOMBIE_BLINKER_BOT_HEALTH_MAX					=		1800; //360
...
new Float:FCVAR_ZOMBIE_BLINKER_SPEED_MIN				=		1.34; //1.14
new Float:FCVAR_ZOMBIE_BLINKER_SPEED_MAX				=		1.36; //1.16
new Float:FCVAR_ZOMBIE_BLINKER_BOT_SPEED_MIN			=		1.32; //1.12
...
*/
new Float:FCVAR_ZOMBIE_STALKER_CHANCE					=		22.4; //24.4
...
new Float:FCVAR_ZOMBIE_STALKER_SPEED_MIN				=		1.40; //1.20
new Float:FCVAR_ZOMBIE_STALKER_SPEED_MAX				=		1.42; //1.22
new Float:FCVAR_ZOMBIE_STALKER_BOT_SPEED_MIN			=		1.30; //1.10
new Float:FCVAR_ZOMBIE_STALKER_BOT_SPEED_MAX			=		1.36; //1.16
...
new Float:FCVAR_ZOMBIE_KNIGHT_CHANCE					=		9.9; //11.1
...
new CVAR_ZOMBIE_KNIGHT_HEALTH_MIN						=		60000; //2800
new CVAR_ZOMBIE_KNIGHT_HEALTH_MAX						=		65000; //3400
new CVAR_ZOMBIE_KNIGHT_BOT_HEALTH_MIN					=		60000; //1500
new CVAR_ZOMBIE_KNIGHT_BOT_HEALTH_MAX					=		65000; //3000
...
new Float:FCVAR_ZOMBIE_KNIGHT_SIZE_MAX					=		1.60; //1.44
new CVAR_ZOMBIE_KNIGHT_COLOR_RED						=		255;
new CVAR_ZOMBIE_KNIGHT_COLOR_GREEN						=		166;
new CVAR_ZOMBIE_KNIGHT_COLOR_BLUE						=		166;
new Float:FCVAR_ZOMBIE_KNIGHT_SPEED_MIN					=		1.30; //1.1
new Float:FCVAR_ZOMBIE_KNIGHT_SPEED_MAX					=		1.32; //1.12
new Float:FCVAR_ZOMBIE_KNIGHT_BOT_SPEED_MIN				=		1.30; //1.10
new Float:FCVAR_ZOMBIE_KNIGHT_BOT_SPEED_MAX				=		1.35; //1.15
...
new CVAR_ZOMBIE_BURNER_HEALTH_MIN						=		1300; //300
new CVAR_ZOMBIE_BURNER_HEALTH_MAX						=		1800; //500
new CVAR_ZOMBIE_BURNER_BOT_HEALTH_MIN					=		1300; //300
new CVAR_ZOMBIE_BURNER_BOT_HEALTH_MAX					=		1800; //450
...
new Float:FCVAR_ZOMBIE_BURNER_SPEED_MIN					=		1.36; //1.16
new Float:FCVAR_ZOMBIE_BURNER_SPEED_MAX					=		1.40; //1.20
new Float:FCVAR_ZOMBIE_BURNER_BOT_SPEED_MIN				=		1.40; //1.20
new Float:FCVAR_ZOMBIE_BURNER_BOT_SPEED_MAX				=		1.55; //1.25
new Float:FCVAR_ZOMBIE_BURNER_HURT_BULLET_DETONATE_CHANCE			=		33.33; //0.33
...
new CVAR_ZOMBIE_SMOKER_HEALTH_MIN						=		1300; //300
new CVAR_ZOMBIE_SMOKER_HEALTH_MAX						=		1800; //350
new CVAR_ZOMBIE_SMOKER_BOT_HEALTH_MIN					=		1300; //250
new CVAR_ZOMBIE_SMOKER_BOT_HEALTH_MAX					=		1800; //350
...
new Float:FCVAR_ZOMBIE_SMOKER_SPEED_MAX					=		1.35; //1.15
new Float:FCVAR_ZOMBIE_SMOKER_BOT_SPEED_MIN				=		1.40; //1.20
...
new Float:FCVAR_ZOMBIE_IED_CHANCE								=		20.0; //12.22
new CVAR_ZOMBIE_IED_RESTRICT									=		0;
new CVAR_ZOMBIE_IED_MAX_SPAWN									=		-2;
new Float:FCVAR_ZOMBIE_IED_MAX_SPAWN_PER_SURVIVORS				=		2.00; //1
new Float:FCVAR_ZOMBIE_IED_MAX_SPAWN_PER_ZOMBIES				=		0.0;
new CVAR_ZOMBIE_IED_HEALTH_MIN									=		1300; //300
new CVAR_ZOMBIE_IED_HEALTH_MAX									=		1800; //350
new CVAR_ZOMBIE_IED_BOT_HEALTH_MIN								=		1300; //200
new CVAR_ZOMBIE_IED_BOT_HEALTH_MAX								=		1800; //320
...
new Float:FCVAR_ZOMBIE_IED_SPEED_MIN							=		1.40; //1.20
new Float:FCVAR_ZOMBIE_IED_SPEED_MAX							=		1.50; //1.30
new Float:FCVAR_ZOMBIE_IED_BOT_SPEED_MIN						=		1.40; //1.20
new Float:FCVAR_ZOMBIE_IED_BOT_SPEED_MAX						=		1.50; //1.30
...
new Float:FCVAR_ZOMBIE_IED_HURT_BULLET_DETONATE_CHANCE			=			50.00; //6.66
new Float:FCVAR_ZOMBIE_IED_HURT_EXPLOSIVE_DETONATE_CHANCE		=			33.33;
new Float:FCVAR_ZOMBIE_IED_HURT_BURN_DETONATE_CHANCE			=			33.33;
new Float:FCVAR_ZOMBIE_IED_C4_DETONATE_DISTANCE					=			600.0;
new Float:FCVAR_ZOMBIE_IED_GRENADE_DETONATE_DISTANCE			=			500.0;
new Float:FCVAR_ZOMBIE_IED_C4_CHANCE							=			33.33;
	new Float:FCVAR_ZOMBIE_IED_C4_BADASS_CHANCE					=			33.33;
...
new CVAR_ZOMBIE_LEAPER_HEALTH_MIN						=		1300; //300
new CVAR_ZOMBIE_LEAPER_HEALTH_MAX						=		1800; //400
new CVAR_ZOMBIE_LEAPER_BOT_HEALTH_MIN					=		1300; //250
new CVAR_ZOMBIE_LEAPER_BOT_HEALTH_MAX					=		1800; //350
...
new Float:FCVAR_ZOMBIE_LEAPER_SPEED_MIN				=		1.40; //1.20
new Float:FCVAR_ZOMBIE_LEAPER_SPEED_MAX				=		1.45; //1.25
new Float:FCVAR_ZOMBIE_LEAPER_BOT_SPEED_MIN				=		1.40; //1.20
new Float:FCVAR_ZOMBIE_LEAPER_BOT_SPEED_MAX				=		1.50; //1.25
...
new Float:FCVAR_ZOMBIE_BURN_BONUS_SPEED_MIN				=			0.22; //0.14
new Float:FCVAR_ZOMBIE_BURN_BONUS_SPEED_MAX				=			0.28; //0.20
		...
		if (FindDataMapInfo(iAimTarget, "m_ModelName") != -1)
		{
			...
			if (StrEqual(sClassName, "LuaCustomModel", true))
			{
				...
				if (StrContains(sModelPath, "ammocrate3.mdl", true) != -1)
				{
					...
					{
						PrintCenterText(client, "按 \"装备配置键 (M)\" 来重新补给\n \n弹药补给剩余量:  [%d / 2]", RoundToNearest(GetEntPropFloat(iAimTarget, Prop_Data, "m_flLocalTime")));
				...
				else if (GetEntPropEnt(iAimTarget, Prop_Data, "m_hOwnerEntity") == 0)
				{
					...
					else if (GetEntPropFloat(iAimTarget, Prop_Data, "m_flLocalTime") == 1.0 && (StrContains(sModelPath, "sandbagwall", true) != -1 || StrContains(sModelPath, "prop_fortification_hesco", true) != -1 || StrContains(sModelPath, "barrier", true) != -1))
					{
						...
						if (GetVectorDistance(vOrigin, vTargetOrigin) <= 80.0)
						{
							if (StrEqual(g_sPlayerClassTemplate[client], "template_demolitions_security_coop", true) || StrEqual(g_sPlayerClassTemplate[client], "template_breacher_security_coop", true))
							{
...
//										TeleportEntity(g_iPlayerTempProp[client], Float:{-4000.0, 0.0, -4000.0}, NULL_VECTOR, NULL_VECTOR);
								...
								if (!bFailed && (g_iPlayerCustomGear[client] != 17 && fDistance <= 100.0) || (g_iPlayerCustomGear[client] == 17 && fDistance <= 140.0))
								{
									...
									if (!TR_DidHit())
									{
										...
										{
											g_fPlayerTempPropTimestamp[client] = g_fGameTime+20.0;
											if (g_fGameTime-g_fPlayerLastChat[client] >= 3.0)
											{
												g_fPlayerLastChat[client] = g_fGameTime;
...
//												ClientCommand(client, "lastinv");
												...
												else if (g_iPlayerCustomGear[client] == 18)
												{
													...
													SetEntPropFloat(g_iPlayerTempProp[client], Prop_Data, "m_flLocalTime", 2.0);
...
public QueryConVar_HLSS(QueryCookie:cookie, client, ConVarQueryResult:result, const String:cvarName[], const String:cvarValue[])
{
	if (result == ConVarQuery_Okay && StringToInt(cvarValue) == 1)
		KickClient(client, "You need to set  >>  voice_inputfromfile  0  <<  ");
}
			...
			if (damagetype & DMG_BULLET)
			{
				...
				switch(g_iLastHitgroup[victim])
				{
					...
					default:
					{
						...
						if (StrContains("m40a1;cheytac_m200;mosin;gol;kar98;enfield;remingtonmsr", sWeaponName, false) == -1)
						{
							bChanged = true;
							if (StrContains("saiga12;m590;m1014;nova;ksg;toz;spas12;taurusjudge;aks74u;asval;vector;mac10;mp40;mp5;mp5a4;mp7;scorpionevo3;spectre;suomi;sten;p90;sterling;thompson;ump45;uzi;pp19", sWeaponName, false) == -1)
								damage /= 4.0;
							else
								damage /= 2.5;
						}
